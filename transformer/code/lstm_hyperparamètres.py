...
from lstm_param import SEQUENCE_LENGTH, device, chemin_data_train, embed_dim, hidden_dim, learning_rate, epochs, num_layers
...
space = {
    ...
    'batch_size': hp.quniform('batch_size', 16, 600, 2)
