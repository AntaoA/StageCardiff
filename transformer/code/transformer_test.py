...
import pickle
import os
from transformer_param import chemin_data_train, chemin_data_test, chemin_t
from transformer_param import device, PAD_TOKEN, SEP_TOKEN, START_TOKEN, END_TOKEN, name_transformer
import torch
